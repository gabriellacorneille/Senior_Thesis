...
ggsave("TablesFigures/focal ID -> density/focal male/2018/2018_focal_male_north.png",
       width = 8,
       height = 6,
       dpi = 600)
...
ggplot() +
  # Draw lines connecting each regular female to its focal male
  geom_segment(data = links %>% filter(year == 2019, region == "south"),
               aes(x = X_foc, y = Y_foc, xend = X_reg, yend = Y_reg),
               color = "gray70", size = 0.5) +
  
  # Plot regular females
  geom_point(data = females %>% 
               filter(year == 2019, region == "south") %>% 
               st_drop_geometry(),
             aes(x = X, y = Y),
             color = "blue", size = 1.5) +
...
ggsave("TablesFigures/focal ID -> density/focal male/2019/2019_focal_male_south.png",
       width = 8,
       height = 6,
       dpi = 600)
...
ggplot() +
  # Draw lines connecting each regular female to its focal male
  geom_segment(data = links %>% filter(year == 2020, region == "north"),
               aes(x = X_foc, y = Y_foc, xend = X_reg, yend = Y_reg),
               color = "gray70", size = 0.5) +
  
  # Plot regular females
  geom_point(data = females %>% 
               filter(year == 2020, region == "north") %>% 
               st_drop_geometry(),
             aes(x = X, y = Y),
             color = "blue", size = 1.5) +
...
ggsave("TablesFigures/focal ID -> density/focal male/2020/2020_focal_male_north.png",
       width = 8,
       height = 6,
       dpi = 600)
...
ggplot() +
  # Draw lines connecting each regular female to its focal male
  geom_segment(data = links %>% filter(year == 2021, region == "south"),
               aes(x = X_foc, y = Y_foc, xend = X_reg, yend = Y_reg),
               color = "gray70", size = 0.5) +
  
  # Plot regular females
  geom_point(data = females %>% 
               filter(year == 2021, region == "south") %>% 
               st_drop_geometry(),
             aes(x = X, y = Y),
             color = "blue", size = 1.5) +
...
ggsave("TablesFigures/focal ID -> density/focal male/2021/2021_focal_male_south.png",
       width = 8,
       height = 6,
       dpi = 600)
...
ggplot() +
  # Draw lines connecting each regular female to its focal male
  geom_segment(data = links %>% filter(year == 2022, region == "north"),
               aes(x = X_foc, y = Y_foc, xend = X_reg, yend = Y_reg),
               color = "gray70", size = 0.5) +
  
  # Plot regular females
  geom_point(data = females %>% 
               filter(year == 2022, region == "north") %>% 
               st_drop_geometry(),
             aes(x = X, y = Y),
             color = "blue", size = 1.5) +
...
ggsave("TablesFigures/focal ID -> density/focal male/2022/2022_focal_male_north.png",
       width = 8,
       height = 6,
       dpi = 600)
...
ggplot() +
  # Draw lines connecting each regular female to its focal male
  geom_segment(data = links %>% filter(year == 2023, region == "south"),
               aes(x = X_foc, y = Y_foc, xend = X_reg, yend = Y_reg),
               color = "gray70", size = 0.5) +
  
  # Plot regular females
  geom_point(data = females %>% 
               filter(year == 2023, region == "south") %>% 
               st_drop_geometry(),
             aes(x = X, y = Y),
             color = "blue", size = 1.5) +
...
ggsave("TablesFigures/focal ID -> density/focal male/2023/2023_focal_male_south.png",
       width = 8,
       height = 6,
       dpi = 600)
...
ggplot() +
  # Draw lines connecting each regular female to its focal male
  geom_segment(data = links %>% filter(year == 2024, region == "north"),
               aes(x = X_foc, y = Y_foc, xend = X_reg, yend = Y_reg),
               color = "gray70", size = 0.5) +
...
ggsave("TablesFigures/focal ID -> density/focal male/2024/2024_focal_male_north.png",
       width = 8,
       height = 6,
       dpi = 600)
...
ggplot() +
  # Draw lines connecting each regular female to its focal male
  geom_segment(data = links %>% filter(year == 2025, region == "mid"),
               aes(x = X_foc, y = Y_foc, xend = X_reg, yend = Y_reg),
               color = "gray70", size = 0.5) +
  
  # Plot regular females
  geom_point(data = females %>% 
               filter(year == 2025, region == "mid") %>% 
               st_drop_geometry(),
             aes(x = X, y = Y),
             color = "blue", size = 1.5) +
...
ggsave("TablesFigures/focal ID -> density/focal male/2025/2025_focal_male_mid.png",
       width = 8,
       height = 6,
       dpi = 600)
